...
char topic_bluebutton_sw[] = {"pantoja_bluebutton_sw"}; //pantoja_bluebutton_sw

// White button topic where the digital twin will transmit its messages.
char topic_whitebutton_sw[] = {"pantoja_whitebutton_sw"};
...
static void HT_FSM_PushButtonHandleState(void) {
    ...
    case HT_BLUE_BUTTON:
        ...
        memset(topic, 0, sizeof(topic));
        sprintf(topic, "pantoja_bluebutton_fw");
    ...
    case HT_WHITE_BUTTON:
        ...
        memset(topic, 0, sizeof(topic));
        sprintf(topic, "pantoja_whitebutton_fw");
